...
selected_cpgs, id_windows = open_genomic_regions(args.genomic_regions, args.cpg_reads_data, args.data_from, args.meth_min, args.meth_max, args.window_size, args.number_of_cpgs)

writeout(args.cpg_reads_data, id_windows, selected_cpgs, args.data_from, command_line)
